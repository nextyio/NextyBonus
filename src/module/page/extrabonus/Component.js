...
export default class extends LoggedInPage {
    ...
    loadData() {
        ...
        this.props.getExtraBonusPercent().then((_percent) => {
            this.setState({
    ...
    ord_renderBreadcrumb() {
        return (
            <Breadcrumb style={{ 'marginLeft': '16px', 'marginTop': '16px', float: 'right' }}>
                ...
                <Breadcrumb.Item> Extra Bonus</Breadcrumb.Item>
            </Breadcrumb>
        );
    }
    ...
    onConfirm() {
        ...
        const self= this;
        this.props.callFunction('setExtraBonusPercent', [this.state.setPercent]).then((result) => {
            console.log("called setExtraBonusPercent func")
            if (!result) {
